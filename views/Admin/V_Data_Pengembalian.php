...
<head>
  ...
  <title>SIPAS | Data Pengembalian</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Transaksi / Data Pengembalian</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                ?>
                <button class = "btn btn-success"> <a href="../../proses/P_export_datapengembalian.php" class="nav-link" style="color:white">Export Ke Excel</a></button>
                <div>
                </div>
                <br>
                ...
                <thead>
                  ...
                  <?php
                    include "../../connection/koneksi.php";
                    $Data = mysqli_query($koneksi,"SELECT * from t_anggota JOIN t_peminjaman USING(Kd_Anggota) JOIN t_buku USING(Kd_Buku) WHERE Status_Peminjaman = 'DIKEMBALIKAN'");
                    $No = 0;
