...
<head>
  ...
  <title>SIPAS | Data Anggota</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Anggota / Data Anggota</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              ?>
                ...
                <thead>
                  ...
                  <?php
                    include "../../connection/koneksi.php";
                    $Data = mysqli_query($koneksi,"SELECT * from t_anggota");
                    $No = 0;
                  ...
                  ?>
                  <tr>
                    <td style="width:10%;"><?php echo $Kd_Anggota?></td>
                    <td style="width:20%;"><img src="../../dist/img/<?php echo $foto ?>" alt="User Image" width="128px" height="128px"></td>
                    ...
                    <td style="width:10%; text-align:center;">
                      ...
                      <a class="btn btn-danger"
                        href="../../proses/P_DeleteAnggota.php?Kd_Anggota=<?php echo $result['Kd_Anggota']; ?>" value="Delete" onclick="return confirm('Yakin Hapus?')">Delete</a>
                    </td>
                  </tr>
                  <?php
                    }
