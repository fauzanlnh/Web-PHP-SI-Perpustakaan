...
<head>
  ...
  <title>SIPAS | Form Ubah Foto Profile</title>
  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Form Ubah Foto Profile</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="dashboard_admin.php">Home</a></li>
                <li class="breadcrumb-item active">Setting / Ubah Profile / Ubah Foto Profile</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
              <form role="form" method="post" action="../../proses/P_UbahFoto.php" enctype="multipart/form-data">
                <div class="card-body">
                  <?php
                    if(isset($_GET['pesan'])){
                      $pesan = $_GET['pesan'];
                            ...
                            <?php
                              if(isset($_GET['pesan'])){
                                $pesan = $_GET['pesan'];
                                  if($pesan == "FotoKosong"){
                                  ?>
                                    <input type='text' id='exampleInputFile' name='kd_pegawai' value='<?php echo$_SESSION['kd_pegawai']?>' hidden>
                                  <?php
                                  }
                                }else{
                                  ?>
                                  <input type='text' id='exampleInputFile' name='kd_pegawai' value='<?php echo$_GET['kd_pegawai']?>' hidden>
                                  <?php
                                }
                                ?>
                          </div>
