...
<head>
  ...
  <title>SIPAS | Form Peminjaman Buku</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Transaksi / Form Peminjaman</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
              ...
              <form role="form" method="post" action="../../proses/P_TambahPeminjaman.php">
                <div class="card-body">
                      ...
                      if(isset($_GET['pesan'])){
                        ...
                        if($pesan == "MasihKosong" || $pesan == "KdTidakAda"){
                          if(($_SESSION['Tanggal']) == '1970-01-01'){
                            ...
                            echo"<label>Tanggal Pinjam:</label>
                                <div class='input-group date'>
                                <input type='date' class='form-control datetimepicker-input' name='Tanggal' value='".$Tanggal_PHP."'readonly>
                                </div>";
                          }
                        }
                      }else{
                  ...
                  <div class="form-group">
                    ...
                    <?php
                    include '../connection/koneksi.php';
                    $Data = mysqli_query($koneksi, "SELECT * FROM t_buku WHERE  Status = 'TERSEDIA' ORDER BY Judul_Buku ASC");
                    while($result = mysqli_fetch_array($Data)){
                      if(isset($_GET['pesan'])){                                             
                        $Kd_Buku = $_SESSION['Kd_Buku'];
                        if($Kd_Buku == $result['Kd_Buku']){
                          $select = "selected";
                        }else{
                          $select = "";
                        }
                      }
                      echo"<option $select value='".$result['Kd_Buku']."'>";
                      echo $result['Judul_Buku'] ." - ". $result['Kd_Buku'];
                      echo"</option>";
                    }
