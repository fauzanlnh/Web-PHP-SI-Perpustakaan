        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Buku / Data Buku</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              ?>
                <button class = "btn btn-success"> <a href="../../proses/P_export_databuku.php" class="nav-link" style="color:white">Export Ke Excel</a></button>
                <div>
                </div>
                <br>
                ...
                <thead>
                  ...
                  <?php
                    include "../../connection/koneksi.php";
                    $Data = mysqli_query($koneksi,"SELECT * from t_buku WHERE Status = 'TERSEDIA' OR Status ='DIPINJAM'");
                    $No = 0;
