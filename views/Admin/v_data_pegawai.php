...
<head>
  ...
  <title>SIPAS | Data Pegawai</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Setting / Data Pegawai</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              ?>
                ...
                <thead>
                  ...
                  <?php
                    include "../../connection/koneksi.php";
                    $Data = mysqli_query($koneksi,"SELECT * from t_pegawai");
                    $No = 0;
                  ...
                  ?>
                  <tr>
                    <td style="width:10%;"><?php echo $kd_pegawai?></td>
                    <td style="width:20%;"><img src="../../dist/img/<?php echo $foto ?>" alt="User Image" width="128" height="128"></td>
                    <td><?php echo $nama_pegawai?></td>
                    <td style="width:10%; text-align:center;">
                      <a class="btn btn-warning"
                        href="v_ubahpegawai.php?kd_pegawai=<?php echo $result['kd_pegawai']; ?>"><i
                        value="Edit">Edit</a>
                      <a class="btn btn-danger"
                        href="../../proses/P_DeletePegawai.php?kd_pegawai=<?php echo $result['kd_pegawai']; ?>" value="Delete" onclick="return confirm('Yakin Hapus?')">Delete</a>
                    </td>
                  </tr>
                  <?php
                    }
